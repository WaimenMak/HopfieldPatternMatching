...
% data = Generate_data(100,scale,N,q_num, PT,0.2);  %number of warping pattern, scaling, number of template
% data = Generate_negative(100,scale,N,q_num, PT,0.2);  %number of warping pattern, scaling, number of template
